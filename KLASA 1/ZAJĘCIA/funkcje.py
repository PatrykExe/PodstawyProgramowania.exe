...
#n = 10 tzw. parametr z argumentem domyślnym
def hurra3(n = 10):
    print('Hurra!\n' * n)
...
#Jeżeli funkcja po prostu wykonuje jakąś czynność i nie możemy wykorzystać dalej efektów jej pracy to jest to procedura
