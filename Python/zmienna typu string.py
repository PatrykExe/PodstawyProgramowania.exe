...
# # #3) Łączenie napisów
# #
# # lista_napisow = ['Windows', 'XP', 'został', 'stworzony', 'z', 'pasją']
# # cale_zdanie = ' '.join(lista_napisow) #join() umożliwia podanie 'separatora', którym będą oddzielone elementy listy
# # print(cale_zdanie)
# #
